...
""")
    ...
    def mostrar_notas(self, notas=None):
        ...
        for n in notas:
            print(" ")
            print("El id de la nota es: ", n.id)
            print("Su texto es: ", n.texto)
            print("Su etiqueta es: ", n.etiquetas)
    ...
    def agregar_nota(self):
        ...
        etiquetas = input("Ingrese la etiqueta de la nueva nota: ")
        self.anotador.nueva_nota(texto, etiquetas)
        print("Su nota se ha creado correctamente.")
